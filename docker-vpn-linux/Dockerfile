...
MAINTAINER paul.kelleher@smartfocus.com

RUN apt-get update && \
  apt-get install -y expect sshfs nfs-common wget net-tools iproute ipppd iptables ssh curl && \
